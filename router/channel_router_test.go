...
func TestChannelBalanceSetRouteUsesOperatePermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodPost, "/update_balance/:id", authz.ChannelOperate, controller.SetChannelBalance)
}
